...
def test_add_category_uc(db_session):
    ...
    assert categories_on_db[0].name == "Roupa de cama"
    assert categories_on_db[0].slug == "roupa-de-cama"
...
def test_delete_category(db_session):
    category_model = CategoryModel(name="Roupa de cama", slug="roupa-de-cama")
