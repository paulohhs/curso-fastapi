...
def test_register_user_username_alredy_exists(db_session):
    user_on_db = UserModel(username="Paulo", password=crypt_context.hash("pass#"))
    ...
    user = User(username="Paulo", password=crypt_context.hash("pass#"))
